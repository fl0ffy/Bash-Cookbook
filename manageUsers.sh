...
# Input parameters:
# Sample usage:        ./users.sh -n USERNAME -g GROUP,GROUP -k RSA,DSA -t REMOTE_USER,REMOTE_HOST,REMOTE_KEY -i USERNAME --admin
######################################################
...
case $opt in
	...
	tar -cvf /tmp/transfer/$username.tar /home/$username/.ssh/id_rsa.pub /home/$username/.ssh/authorized_keys2 &>/dev/null
